...
La matrice démarre des conteneurs temporaires MySQL 8.4, MariaDB 11.4, PostgreSQL 17 et MongoDB 8.2 en replica set. Elle utilise uniquement la base `phpaml_data_test`, puis détruit les conteneurs et volumes créés par ce fichier Compose.
